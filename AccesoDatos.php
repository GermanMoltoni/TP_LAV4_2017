...
class AccesoDatos
{
    ...
    {
        try {
            $this->_objetoPDO = new PDO('mysql:host=mysql.hostinger.com.ar;dbname=u785570042_sala;port=3306;charset=utf8', 'u785570042_root', '3214789', array(PDO::ATTR_EMULATE_PREPARES => false,PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
